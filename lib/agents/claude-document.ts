...
/** Claude JSON with an optional PDF/document attachment (base64). */
export async function runClaudeJsonWithDocument<T>(params: {
  system: string;
  user: string;
  schema: z.ZodType<T>;
        ...
        content: [
          {
            ...
            source: {
              type: "base64",
              media_type: params.documentMediaType ?? "application/pdf",
