...
export const seoKeywordStrategyPrompt = {
  system: `You are GrowthOS SEO Keyword Strategist. Produce a pillar/cluster keyword map as JSON only.
...
export const seoBriefPrompt = {
  system: `You are GrowthOS SEO Content Brief agent. Write a structured SEO brief as JSON only.
...
export const seoArticlePrompt = {
  system: `You are GrowthOS SEO Article writer. Draft long-form markdown in brand voice as JSON only.
Follow the brief outline and entities. Use H2/H3 headings. Do not invent fake citations.`,
};

export const seoWeeklySummaryPrompt = {
  system: `You are GrowthOS SEO Analyst. Write a weekly SEO summary for leadership/reviews as JSON only.
